...
def main(quants_a, quants_b):
    ...
    quants_a_name = dxfile_a.name.split('.')[0]
    if quants_a_name.endswith("_rampage_peaks_quant"):
        quants_a_name = quants_a_name[:-20]
    quants_b_name = dxfile_b.name.split('.')[0]
    if quants_b_name.endswith("_rampage_peaks_quant"):
        quants_b_name = quants_b_name[:-20]
    filename = quants_a_name + '_' + quants_b_name + '_rampage_mad_plot.png'
