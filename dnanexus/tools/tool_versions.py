...
APP_TOOLS = {
    ...
    "bam-to-bigwig":            ["lrna_bam_to_signals.sh", "STAR", "bedGraphToBigWig"],
...
VIRTUAL_APPS = {
    # lrna virtuals:
    "bam-to-bigwig-se":        "bam-to-bigwig",
    "bam-to-bigwig-tophat":    "bam-to-bigwig",
    "bam-to-bigwig-se-tophat": "bam-to-bigwig",
...
ALL_TOOLS = {
    ...
    "lrna_bam_to_signals.sh":            "lrna_bam_to_signals.sh | grep usage | awk '{print $2}' | tr -d :",
...
def main():
    ...
    if (args.applet is None or args.appver is None) and args.dxjson is None:
        parser.print_help()
        return
